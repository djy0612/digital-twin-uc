module github.com/digital-twin-uc/policy-contract1

go 1.20

require (
	github.com/hyperledger/fabric-contract-api-go v1.2.2
	github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go v0.0.0-20250212133417-5e91d365d44e
